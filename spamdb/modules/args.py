...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--secret', help='shhh!', default='9qEYN0ThHer1KWLNekA76Q==')
    parser.add_argument(
        '--user-bg',
        '-b',
        type=int,
    ...
    parser.add_argument('--students', type=int, default=10, help='(default: 10)')
    parser.add_argument(
        '--games',
        type=int,
    ...
    parser.add_argument(
        '--jsbots',
        action='store_true',
        help='create browser bots & assets',
    )
    parser.add_argument(
        '--list-ratings',
        action='store_true',
